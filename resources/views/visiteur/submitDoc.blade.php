...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-row">
    <div class="form-group">
      <label for="theme">Theme du pojet</label>
  ...
  <div class="row">
    ...
    <div class="form-group col-md-4">
      ...
      <input required type="tel" id="telEncadreur" class="form-control"
      name="telEncadreur">
    </div>
    <div class="form-group col-md-4">
      <label for="matriculeEncadreur">Matricule de l'encadreur</label>
      <input required type="text" class="form-control"  id="matriculeEncadreur" name="matriculeEncadreur">
    </div>
  </div>
