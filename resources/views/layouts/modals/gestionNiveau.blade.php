                ...
                <form action="" method="post" id="editNiveauForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" required name="code" id="code"
                            placeholder="SVP Entrez le code du niveau">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label">intitule</label>
                        <input type="text" class="form-control" name="intitule" required id="intitule" placeholder="SVP entrez l'intitule du niveau">
                    </div>
