                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a href="<?php echo e(route('Ecole_Doctorat.unite_recherche.create')); ?>"
                            <?php if(isset($ur_c)): ?> class="active" <?php endif; ?>>
        ...
        <?php if(Auth::user()->profil_id == 0): ?>
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a
                            href="<?php echo e(route('Admin.departement.create')); ?>"<?php if(isset($departement_c)): ?> class="active" <?php endif; ?>>
                            <i class="bi bi-circle"></i><span> Ajouter un Departement</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('Admin.niveau.create')); ?>"
                            <?php if(isset($niveau_c)): ?> class="active" <?php endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\Team4-Plateforme-de-l-ecole-doctorale-Module-de-publication-des-travaux-des-etudiants\resources\views/layouts/admin/sidebarDonneeedebase.blade.php ENDPATH**/ ?>