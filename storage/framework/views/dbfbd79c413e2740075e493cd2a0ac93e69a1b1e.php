    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <?php if(Auth::user()->profil_id == 0 || Auth::user()->profil_id == 1): ?>
            <li class="nav-item">
                ...
                <ul id="table-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
                    ...
                    <li>
                        <a
                            href="<?php echo e(route('Ecole_Doctorat.Inscription.index')); ?>"<?php if(isset($inscription)): ?> class="active" <?php endif; ?>>
        ...
        <?php if(Auth::user()->profil_id == 0 || Auth::user()->profil_id == 2 || Auth::user()->profil_id == 4): ?>
            <li class="nav-item">
                ...
                <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <?php if(Auth::user()->profil_id == 2 || Auth::user()->profil_id == 4): ?>
                        <li>
                            <a href="<?php echo e(route('Admin.etudiant.createFil', Auth::user()->departement_id)); ?>"
                                <?php if(isset($etudiant_c)): ?> class="active" <?php endif; ?>>
                                <i class="bi bi-circle"></i><span> Ajouter un Etudiant</span>
                            </a>
                        </li>
                    <?php endif; ?>
                ...
                <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
                    ...
                    <?php if(Auth::user()->profil_id == 0): ?>
                        <li>
                            <a href="<?php echo e(route('Admin.niveau.index')); ?>"
                                <?php if(isset($niveau_i)): ?> class="active" <?php endif; ?>>
                    ...
                    <li>
                        <a href="<?php echo e(route('Admin.ue.index')); ?>"
                            <?php if(isset($ue_i)): ?> class="active" <?php endif; ?>>
...
<?php /**PATH C:\xampp\htdocs\Team4-Plateforme-de-l-ecole-doctorale-Module-de-publication-des-travaux-des-etudiants\resources\views/layouts/admin/sidebarFaculte.blade.php ENDPATH**/ ?>