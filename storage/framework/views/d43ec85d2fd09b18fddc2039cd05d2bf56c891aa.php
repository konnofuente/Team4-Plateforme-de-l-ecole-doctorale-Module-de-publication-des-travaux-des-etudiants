...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        <?php if(Auth::user()->profil_id != 1): ?>
            <li class="nav-item">
                <a class="nav-link <?php if(!isset($admin_i)): ?> collapsed <?php endif; ?>" href="<?php echo e(route('Admin.index')); ?>">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if(!isset($user_i)): ?> collapsed <?php endif; ?>"
        ...
        <?php if(Auth::user()->profil_id == 0 || Auth::user()->profil_id == 2 || Auth::user()->profil_id == 4): ?>
            ...
            <li class="nav-item">
                <a class="nav-link <?php if(!isset($utilisateur_i)): ?> collapsed <?php endif; ?> "
...
<?php /**PATH C:\xampp\htdocs\Team4-Plateforme-de-l-ecole-doctorale-Module-de-publication-des-travaux-des-etudiants\resources\views/layouts/admin/sidebarAdminIndex.blade.php ENDPATH**/ ?>