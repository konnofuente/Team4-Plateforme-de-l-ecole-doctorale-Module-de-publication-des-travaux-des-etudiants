<!DOCTYPE html>
<html lang="fr">
<?php echo $__env->make('layouts.visitor.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<header>
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
    <div class="position-sticky">
      <div class="list-group list-group-flush mx-3 mt-4">
        <a href="<?php echo e(route('visiteur.all')); ?>" class="list-group-item list-group-item-action py-2 ripple active">
          <i class="fas fa-tachometer-alt fa-fw me-3"></i><span>Memoires Recent</span>
        </a>
        <a href="<?php echo e(route('visiteur.creer')); ?>" class="list-group-item list-group-item-action py-2 ripple ">
  ...
  <nav id="main-navbar" class="navbar navbar-expand-lg navbar-light bg-white fixed-top"
    style="box-shadow: 0 5px 20px -5px;height:80px;"
  >
    <!-- Container wrapper -->
...
<?php /**PATH C:\xampp\htdocs\Team4-Plateforme-de-l-ecole-doctorale-Module-de-publication-des-travaux-des-etudiants\resources\views/layouts/visitor/body.blade.php ENDPATH**/ ?>