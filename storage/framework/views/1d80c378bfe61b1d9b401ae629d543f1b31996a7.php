    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="<?php echo e(route('Ecole_Doctorat.message.store')); ?>" method="post" id="editNewForm">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Team4-Plateforme-de-l-ecole-doctorale-Module-de-publication-des-travaux-des-etudiants\resources\views/layouts/modals/dossiermessageupdate.blade.php ENDPATH**/ ?>