...
Route::controller(MemoiresController::class)->group(function(){
    Route::get('memoires','index')->name('memoires.all');
    Route::get('memoires/memoire/{id}','show')->name('memoires.viewOne');
});
